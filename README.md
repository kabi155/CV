...
<head>
    ...
    <style>
        ...
        .enter-btn, .signup-btn, .login-btn, .photo-btn, .back-btn {
            margin-top: 20px;
            padding: 10px 20px;
            font-size: 1.5em;
            background: gold;
        ...
        .login-btn {
            background: #4285f4; /* Blue color for login */
            color: white;
        }
        .login-btn:hover {
            background: #357abd;
...
<body>
    ...
    <div class="content">
        ...
        <button class="login-btn" onclick="loginSite()">Login</button> <!-- New Login Button -->
    ...
    <script>
        ...
        function loginSite() {
            window.location.href = "kabiraj login.html"; // Link to the login page
        }
